...
of lightning-training-studio and a lightning-vision-vision's visionlab.components [.hpo.work](https://github.com/JustinGoheen/lightning-vision-vision/blob/master/visionlab/components/hpo/work.py) and [.train.work](https://github.com/JustinGoheen/lightning-vision-vision/blob/master/visionlab/components/train/work.py).
...
In the example [visionlab.core.module](https://github.com/JustinGoheen/lightning-vision-vision/blob/master/visionlab/core/module.py) (a VisionTransform), the tuneable parameters are `lr`, `optimizer`, `dropout`, `attention_dropout`, `norm_layer` where:
