...
from visionpod.components.train import TrainWork, TunedTrainWork
...
def sweep_and_train(
    ...
    trainer = TunedTrainWork(experiment_manager=em, project_name=project_name, trial_count=trial_count)
    trainer.run(
        project_name,
